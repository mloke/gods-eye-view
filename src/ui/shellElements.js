...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _watchPanel: document.getElementById('watch-panel'),
    _watchList: document.getElementById('watch-list'),
    _watchStatus: document.getElementById('watch-status'),
    _watchEnableBtn: document.getElementById('watch-enable-btn'),
    _watchClearBtn: document.getElementById('watch-clear-btn'),
    _watchDrawBtn: document.getElementById('watch-draw-btn'),
    _watchZoneName: document.getElementById('watch-zone-name'),
    _watchDrawHint: document.getElementById('watch-draw-hint'),
    _watchFences: document.getElementById('watch-fences'),
    ...
    _globalContextSolarBtn: document.getElementById(
      'global-context-solar-btn',
    ),
    _globalContextCommandBtn: document.getElementById(
    ...
    _contextSolarView: document.getElementById('context-solar-view'),
    _contextCommandView: document.getElementById('context-command-view'),
    ...
    _locationTabCities: document.getElementById('location-tab-cities'),
    _locationTabSaved: document.getElementById('location-tab-saved'),
    _locationCitiesView: document.getElementById('location-cities-view'),
    _locationSavedView: document.getElementById('location-saved-view'),
    _locationSavedList: document.getElementById('location-saved-list'),
